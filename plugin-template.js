...
define('seajs/plugin-template', ['seajs/plugin-text'], function (require, exports, module) {

  // Here is only work for seajs v1.3.0-dev
  // If you are 1.2.1 or below, please uncomment the below script
  // require('seajs/plugin-text');
  /**
   * 模板引擎路由函数
  ...
  (function () {
    ...
    var _cache = {}
    ,   _isNewEngine = ''.trim
    ,   _isServer = _isNewEngine && !window.document
    ,   _keyWordsMap = {}
    ;
    ...
    exports.render2 = function (id, target, data) {
      if ( arguments.length <= 2 && typeof(arguments[1]) === 'object' ) {
        ...
        if ( !_cache.hasOwnProperty(id) ) {
          ...
          _append2document(_cache[id]);
        }
      } else if ( typeof(arguments[1]) === 'string' ) {
        if ( !_cache.hasOwnProperty(id) ) {
          require.async('views/'+ id +'.tpl', function (res) {
            _cache[id] = exports.compile(res)(data);
            return exports.render2(id, target, data);
          });
        } else {
          _append2document(_cache[id], target);
        }
      }
    };
    ...
    // Append to document
    var _append2document = function (content, targetElem) {
      var div
      ,   _fb_root
      ,   fb_root_parent
      ;
